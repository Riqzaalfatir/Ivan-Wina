...
const CountingDown = () => {
  ...
  const renderer = ({ days, hours, minutes, seconds, completed }: any) => {
    ...
    return (
      ...
      >
        <div className="flex flex-col gap-1.5 md:gap-1">
          <motion.h4 key={days} initial={{ scale: 0.8, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} transition={{ duration: 0.3 }} className="text-white font-medium font-sweetsans text-[32px] md:text-[59px] lg:text-[54px] leading-none tabular-nums">
        ...
        <div className="flex flex-col gap-1.5 md:gap-1">
          <motion.h4 key={hours} initial={{ scale: 0.8, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} transition={{ duration: 0.3 }} className="text-white font-medium font-sweetsans text-[32px] md:text-[59px] lg:text-[54px] leading-none tabular-nums">
        ...
        <div className="flex flex-col gap-1.5 md:gap-1">
          <motion.h4 key={minutes} initial={{ scale: 0.8, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} transition={{ duration: 0.3 }} className="text-white font-medium font-sweetsans text-[32px] md:text-[59px] lg:text-[54px] leading-none tabular-nums">
        ...
        <div className="flex flex-col gap-1.5 md:gap-1">
          <motion.h4 key={seconds} initial={{ scale: 0.8, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} transition={{ duration: 0.3 }} className="text-white font-medium font-sweetsans text-[32px] md:text-[59px] lg:text-[54px] leading-none tabular-nums">
