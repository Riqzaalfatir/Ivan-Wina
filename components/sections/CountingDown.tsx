...
const CountingDown = () => {
  ...
  if (completed) {
   ...
   return (
    <div className="flex items-center text-center mb-[75px] gap-[55px]">
      <div className="flex flex-col gap-0">
        <h4 className="text-white font-medium font-sweetsans text-[54px] leading-none">{days.toString().padStart(2, "0")}</h4>
        <p className="text-white font-bold font-sweetsans text-[18px] leading-none uppercase">DAYS</p>
      </div>
      <div className="flex flex-col gap-0">
        <h4 className="text-white font-medium font-sweetsans text-[54px] leading-none">{hours.toString().padStart(2, "0")}</h4>
        <p className="text-white font-bold font-sweetsans text-[18px] leading-none uppercase">Hours</p>
      </div>
      <div className="flex flex-col gap-0">
        <h4 className="text-white font-medium font-sweetsans text-[54px] leading-none">{minutes.toString().padStart(2, "0")}</h4>
        <p className="text-white font-bold font-sweetsans text-[18px] leading-none uppercase">Minutes</p>
      </div>
      <div className="flex flex-col gap-0">
        <h4 className="text-white font-medium font-sweetsans text-[54px] leading-none">{seconds.toString().padStart(2, "0")}</h4>
        <p className="text-white font-bold font-sweetsans text-[18px] leading-none uppercase">Seconds</p>
      </div>
    </div>
  )
    ...
    <section className='w-full bg-[#6C7852] py-[145px]'>
        <div className="max-w-7xl mx-auto px-4">
            <div className="flex flex-col items-center justify-center">
                <h2 className='uppercase font-sweetsans font-bold text-white text-[46px] mb-[60px]'>COUNTING DOWN</h2>

                {/* INI DOANG YANG JALAN */}
